...
## Source of truth
Active, refreshed 2026-09-14. Assignment presentation, task pages, design library, quotation/invoice creator. User screenshots and live review take precedence over generic style rules.
...
## Visual language
Use ink #121212 and near-white #f7f7f2, not a beige presentation. Saturated red #f04428, blue #075dce, orange #ff7800 and yellow #ffdc24 define different creative moments. Keep each frame to two dominant colors; the interface stays ink with red accents. New optical/geometric reference screenshots explicitly authorize this broader campaign palette. Anton display, Jost body; outlined logo masters. Sharp corners and open editorial spacing. Hero combines real site photography, kinetic words and a compact task index. Design variance 9, motion 7, density 5. White quotation artboards sit within the dark presentation. Optical lines, eyes, stars and pop cutouts belong in creative applications, not financial information. Inspiration names and screenshot shelves stay out of the submitted website and PDFs. Original work remains visible where the task requires source critique.
...
## Accessibility
Visible focus, semantic heading order, text labels, 44px controls. No essential text over busy imagery. Automatic motion sequences last less than five seconds and settle without controls. Honor reduced motion. Print is static.
